...
Version 8.1.0 and above supports Generating **An FrontEnd in Angular 18** this make use of the WebAPI backend, all of these are generated with this program generator.
